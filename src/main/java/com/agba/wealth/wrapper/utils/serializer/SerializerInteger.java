...
public class SerializerInteger extends JsonSerializer<Integer> implements ContextualSerializer{
	...
	public SerializerInteger(DecimalFormat decimalFormat) {
	...
	public JsonSerializer<?> createContextual(SerializerProvider prov, BeanProperty property)
		...
		if (format.hasPattern()) {
			...
			return new SerializerInteger(decimalFormat);
		}
